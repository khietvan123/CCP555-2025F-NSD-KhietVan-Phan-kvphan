import { JwtVerifierBase, JwtVerifierProperties } from "aws-jwt-verify/jwt-verifier";
import { JwksCache, Jwks, Jwk } from "aws-jwt-verify/jwk";
import { JwtHeader, JwtPayload, CognitoIdOrAccessTokenPayload } from "aws-jwt-verify/jwt-model";
 ...
 */
export type CognitoJwtVerifierSingleUserPool<T extends CognitoJwtVerifierProperties> = CognitoJwtVerifier<Properties<CognitoVerifyProperties, T>, T & JwtVerifierProperties<CognitoVerifyProperties> & {
    userPoolId: string;
    audience: null;
}, false>;
/**
 ...
 */
export type CognitoJwtVerifierMultiUserPool<T extends CognitoJwtVerifierMultiProperties> = CognitoJwtVerifier<Properties<CognitoVerifyProperties, T>, T & JwtVerifierProperties<CognitoVerifyProperties> & {
    userPoolId: string;
    audience: null;
}, true>;
/**
 ...
 * @returns void
 */
export declare function validateCognitoJwtFields(payload: JwtPayload, options: {
    groups?: string | string[] | null;
    tokenUse?: "id" | "access" | null;
    clientId?: string | string[] | null;
}): void;
 ...
 */
export declare class CognitoJwtVerifier<SpecificVerifyProperties extends Partial<CognitoVerifyProperties>, IssuerConfig extends JwtVerifierProperties<SpecificVerifyProperties> & {
    userPoolId: string;
    audience: null;
}, MultiIssuer extends boolean> extends JwtVerifierBase<SpecificVerifyProperties, IssuerConfig, MultiIssuer> {
     ...
     */
    static create<T extends CognitoJwtVerifierProperties>(verifyProperties: T & Partial<CognitoJwtVerifierProperties>, additionalProperties?: {
        jwksCache: JwksCache;
     ...
     * @returns An Cognito JWT Verifier instance, that you can use to verify Cognito signed JWTs with
     */
    static create<T extends CognitoJwtVerifierMultiProperties>(props: (T & Partial<CognitoJwtVerifierMultiProperties>)[], additionalProperties?: {
        jwksCache: JwksCache;
     ...
     */
    verifySync<T extends SpecificVerifyProperties>(...[jwt, properties]: CognitoVerifyParameters<SpecificVerifyProperties>): CognitoIdOrAccessTokenPayload<IssuerConfig, T>;
    /**
     ...
     */
    verify<T extends SpecificVerifyProperties>(...[jwt, properties]: CognitoVerifyParameters<SpecificVerifyProperties>): Promise<CognitoIdOrAccessTokenPayload<IssuerConfig, T>>;
    /**
     ...
     * @returns void
     */
    cacheJwks(...[jwks, userPoolId]: MultiIssuer extends false ? [jwks: Jwks, userPoolId?: string] : [jwks: Jwks, userPoolId: string]): void;
}
export {};
