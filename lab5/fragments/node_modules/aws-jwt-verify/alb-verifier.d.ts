import { Jwk, JwksCache } from "aws-jwt-verify/jwk";
import { AlbJwtHeader, AlbJwtPayload, JwtHeader } from "aws-jwt-verify/jwt-model";
 ...
 */
export type AlbJwtVerifierSingleUserPool<T extends AlbJwtVerifierProperties> = AlbJwtVerifier<Properties<AlbVerifyProperties, T>, T & JwtVerifierProperties<AlbVerifyProperties> & {
    albArn: string | string[];
    audience: null;
}, false>;
/**
 ...
 */
export type AlbJwtVerifierMultiUserPool<T extends AlbJwtVerifierMultiProperties> = AlbJwtVerifier<Properties<AlbVerifyProperties, T>, T & JwtVerifierProperties<AlbVerifyProperties> & {
    albArn: string | string[];
    audience: null;
}, true>;
/**
 ...
 */
export declare class AlbJwtVerifier<SpecificVerifyProperties extends Partial<AlbVerifyProperties>, IssuerConfig extends JwtVerifierProperties<SpecificVerifyProperties> & {
    audience: null;
    albArn: string | string[];
     ...
     */
    static create<T extends AlbJwtVerifierProperties>(verifyProperties: T & Partial<AlbJwtVerifierProperties>, additionalProperties?: {
        jwksCache: JwksCache;
     ...
     */
    static create<T extends AlbJwtVerifierMultiProperties>(props: (T & Partial<AlbJwtVerifierMultiProperties>)[], additionalProperties?: {
        jwksCache: JwksCache;
     ...
     */
    verifySync(...[jwt, properties]: AlbVerifyParameters<SpecificVerifyProperties>): AlbJwtPayload;
    /**
     ...
     */
    verify(...[jwt, properties]: AlbVerifyParameters<SpecificVerifyProperties>): Promise<AlbJwtPayload>;
}
export declare function validateAlbJwtFields(header: JwtHeader, options: {
    clientId?: string | string[] | null;
    albArn: string | string[];
}): void;
export declare function validateAndParseAlbArns(albArn: string | string[]): AlbArn[];
export {};
